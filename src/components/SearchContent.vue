<template>
    <div class="container mx-auto px-2 py-10 min-h-screen">
        <div v-if="searchResults == null || isJsonEmpty(searchResults)">
            <div class="flex flex-wrap justify-center md:justify-between h-screen">
        ...
        <div v-else>
            <div v-if="searchResults.status == false">
                <div class="flex items-center h-screen p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 "
                    role="alert">
            ...
            <div v-if="searchResults.status == true">

                <h3 class="text-2xl font-bold tracking-tight text-gray-900  text-center my-2">Search Results for "{{ searchQuery }}"
                </h3>
                <div class="flex flex-wrap justify-evenly">
                    <div v-for="item in searchResults.manga_list" :key="item.title">
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <p class="text-gray-500 text-sm ">{{ item.updated_on }}</p>
                                </div>
    ...
    export default {
        ...
        watch: {
            searchQuery: {
                immediate: true,
                handler(newQuery) {
                    // Update search results when searchQuery prop changes
